...
const configForm = reactive({
  ...
  blocked_keywords_text: defaultBlockedKeywords.join('\n'),
...
function applyConfig(config: ContentModerationConfig) {
  ...
  configForm.email_on_hit = config.email_on_hit ?? false
  configForm.auto_ban_enabled = config.auto_ban_enabled ?? false
