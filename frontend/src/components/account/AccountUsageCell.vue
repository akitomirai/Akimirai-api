            ...
            <div class="space-y-1">
              ...
              <div class="mt-2">
                <a :href="geminiQuotaPolicyDocsUrl" target="_blank" rel="noopener noreferrer" class="text-blue-400 hover:text-blue-300 underline">
                  {{ t('admin.accounts.gemini.quotaPolicy.columns.docs') }} �?                </a>
              </div>
            </div>
          </span>
        </span>
...
// Antigravity quota types (用于 API 返回的数�?
