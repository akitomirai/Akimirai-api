export default {
  ...
  auth: {
    ...
    layoutHeroKicker: 'Akimirai Control Plane',
    layoutHeroTitle: 'Make every request land with clarity.',
    layoutHeroDescription: 'A quiet gateway for teams that care about stable access, visible usage and controlled spend.',
    layoutHeroMetricOneValue: '1 Key',
    layoutHeroMetricOneLabel: 'single ingress',
    layoutHeroMetricTwoValue: 'Quota',
    layoutHeroMetricTwoLabel: 'guardrails',
    layoutHeroMetricThreeValue: 'Live',
    layoutHeroMetricThreeLabel: 'signals',
