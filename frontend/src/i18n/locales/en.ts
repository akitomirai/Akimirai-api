export default {
  ...
  nav: {
    ...
    paymentPlans: 'Plans',
    externalFulfillment: 'External Fulfillment',
  ...
  quickStart: {
    kicker: 'Integration',
    title: 'Quick Start',
    description: 'Copy the minimum compatible OpenAI settings and verify requests from one place.',
    baseUrl: 'Base URL',
    model: 'Model',
    apiKey: 'API Key',
    ...
    viewUsage: 'Usage',
    viewErrors: 'Errors',
    loadFailed: 'Failed to load quick start data. Refresh and try again.',
    placeholderKeyHint: 'Regular pages use a placeholder. Create a key to copy the real value once.',
    oneTimeKeyHint: 'This key is only available in the creation result. Copy and save it now.',
    curlExample: 'curl',
    openaiSdkExample: 'OpenAI SDK',
    codexExample: 'Codex',
    commonErrors: 'Common Errors',
    commonErrorsHint: 'Open usage errors for the full request context and suggestion.',
    errors: {
      '403': 'Insufficient balance or subscription unavailable.',
      '429': 'Rate limited. Reduce concurrency or retry later.',
      '502': 'Upstream failed.',
      '503': 'No available channel.',
      streamDisconnected: 'Streaming connection ended before completion.'
    }
  },

  // Auth
  auth: {
    welcomeBack: 'Welcome back. Offer a coin to enter.',
    layoutBrandName: 'Bakaai',
    layoutHeroKicker: 'Gensokyo API Relay',
    layoutHeroTitle: 'Bakaai',
    layoutHeroSubtitle: 'All model gods, one coin offering.',
    layoutHeroDescription: 'Claude, GPT, Gemini and more answer through one API shrine.',
    layoutHeroMetricOneValue: 'API',
    layoutHeroMetricOneLabel: 'single relay',
    layoutHeroMetricTwoValue: 'Multi',
    layoutHeroMetricTwoLabel: 'platforms',
    layoutHeroMetricThreeValue: 'Ledger',
    layoutHeroMetricThreeLabel: 'usage trace',
    layoutFooter: '2026 bakaai',
    signInToAccount: '',
    signIn: 'Sign In',
    ...
    invalidEmail: 'Please enter a valid email address',
    emailLocalPartNotAllowed:
      'This email prefix is not allowed for registration. Please use a different email address.',
  ...
  dashboard: {
    ...
    commercial: {
      ...
      loadFailed: 'Dashboard data failed to load. The main entry points remain available.',
      noBalance: 'No balance data available',
      recharge: 'Recharge',
      redeem: 'Redeem',
      todayUsageTitle: 'Today Usage',
      noTodayStats: 'No today statistics yet',
      requests: 'requests',
      viewUsage: 'View usage',
      keyStatusTitle: 'API Key Status',
      keyLoadFailed: 'Failed to load key status',
      lastUsedAt: 'Last used {time}',
      noKeyUsage: 'No recent key usage',
      createKey: 'Create API Key',
      manageKeys: 'Manage API Keys',
      quickStartTitle: 'Quick Start',
      quickStartDescription: 'Copy the Base URL, create a key, choose a model, and open usage or error records from here.',
      copyBaseUrl: 'Copy Base URL',
      viewQuickStart: 'View Quick Start',
      viewModels: 'View models',
      paymentTitle: 'Recharge and Plans',
      paymentEnabled: 'Recharge, order records, and subscriptions are available.',
      paymentDisabled: 'Recharge is not enabled. Use redeem codes if available.',
      orders: 'Orders',
      subscriptions: 'Subscriptions',
      recentErrorsTitle: 'Recent Errors',
      recentErrorsDescription: 'Only safe, user-facing error fields are shown here.',
      viewErrors: 'View errors',
      errorViewDisabled: 'Error records are not enabled for users.',
      errorLoadFailed: 'Failed to load recent errors.',
      noRecentErrors: 'No recent failed requests.',
  ...
  keys: {
    ...
    copied: 'Copied!',
    keyShownOnce: 'API keys are shown only once after creation. Create a new key if you need the full secret again.',
    integrationExamples: {
      title: 'Integration Examples',
      subtitle: 'Use a placeholder key to configure OpenAI SDK, Codex, Cursor, or Cherry Studio.',
      copyBaseUrl: 'Copy Base URL',
      copyExample: 'Copy example',
      copied: 'Integration config copied',
    },
    ...
    useKeyModal: {
      ...
      copy: 'Copy',
      copied: 'Copied',
      immediateCopyNotice: 'Copy and save this API key now. After you close this dialog, the full key cannot be viewed again.',
      keyName: 'Key name',
      keyPrefix: 'Prefix / masked',
      copyApiKey: 'Copy API Key',
      copyBaseUrl: 'Copy Base URL',
      nextQuickStart: 'Next: Quick Start',
      viewUsage: 'View Usage',
  ...
  usage: {
    ...
    errors: {
      ...
      category: 'Category', platform: 'Platform', message: 'Message', explanation: 'Explanation',
      suggestion: 'Suggestion', retryable: 'Retryable', notRetryable: 'Not retryable',
      charged: 'May be charged', notCharged: 'Usually not charged', errorCode: 'Error Code',
      requestId: 'Request ID',
  ...
  profile: {
    ...
    avatar: {
      ...
      qqTitle: 'QQ Email Avatar',
      qqHint: 'QQ number {qq} was detected. You can choose to use its public QQ avatar.',
      qqLoading: 'Checking QQ email avatar...',
      qqCheckAction: 'Check QQ avatar',
      qqConsentHint: 'After you click check, your QQ email is used to identify the QQ number and load a preview from QQ public avatar service.',
      qqUseAction: 'Use QQ avatar',
      qqCurrent: 'In use',
      qqLoadFailed: 'Failed to check QQ avatar',
      qqUnavailable: 'No available QQ avatar was detected for this account',
      qqImageFailed: 'QQ avatar cannot be previewed right now. You can keep using upload instead.',
      qqPreviewAlt: 'QQ avatar preview',
    },
    authBindings: {
  ...
  admin: {
    ...
    riskControl: {
      ...
      modeObserveDesc: 'Requests pass through while the latest user input is queued for async review; hits are logged, while email and ban counting only run when their switches are enabled.',
      modeOff: 'Off',
      ...
      emailOnHitHint: 'Off by default. When enabled, send risk-control emails to users; when off, only block the request and record an admin audit log.',
      autoBan: 'Auto Ban User',
      autoBanHint: 'Off by default. When enabled, disable the user after the hit threshold is reached; when off, users are never auto-disabled or kicked out.',
      cyberPolicyExcludeBan: 'Exclude Cyber Policy Hits from Ban Count',
      cyberPolicyExcludeBanHint: 'When enabled, cyber_policy hits do not count toward auto-ban violations. Notice emails still follow the Email on Hit switch.',
      ...
      blockedKeywordsDescription: 'Defaults focus on explicit abuse actions. Normal coding, operations, legal API use, defensive education, CTF, and harmless automation should not be blocked by topic words alone.',
      ...
      blockedKeywordsLimit: 'Up to {max} keywords, each no longer than 200 characters. Duplicates are removed automatically; replace broad terms with action-and-intent phrases.',
    ...
    ops: {
      ...
      openaiTokenStats: {
        ...
        subtitle: 'Cache read ratio, TTFT and throughput by model, based on recorded usage logs.',
        viewModeTopN: 'TopN',
        ...
        optimizationTitle: 'Optimization Signals',
        metrics: {
          cacheReadRatio: 'Cache read ratio',
          cacheReadCaption: '{tokens} cached input tokens reused',
          avgFirstToken: 'Avg first token',
          firstTokenCaption: '{requests} requests in this slice',
          avgTokensPerSec: 'Avg output speed',
          tokensPerSecCaption: 'Weighted by request count'
        },
        tips: {
          lowCacheRead: 'Cache hit rate is low for this traffic slice. Keep stable system prompts, tool schemas and reusable context at the beginning of requests so identical prefixes can be reused.',
          cacheWriteHeavy: 'Cache writes are much higher than reads. Check whether request prefixes change too often, or whether users are rotating large context blocks before the reusable prefix.',
          highFirstToken: 'First token latency is high. Review upstream account health, model choice, prompt length and streaming path before tuning application-side retries.',
          healthy: 'Cache reuse and first token latency look acceptable for this slice. Keep watching the model rows with the highest request count.'
        },
        table: {
          model: 'Model',
          ...
          cacheReadRatio: 'Cache Read Ratio',
          totalCacheReadTokens: 'Cache Read Tokens',
          totalCacheCreationTokens: 'Cache Write Tokens',
      ...
      tooltips: {
        ...
        goroutines:
          'Number of Go runtime goroutines (lightweight threads). There is no absolute "safe" number—use your historical baseline. Heuristic: <2k is common; 2k�?k watch; >8k plus rising queue/latency often suggests blocking/leaks.',
    ...
    settings: {
      ...
      payment: {
        ...
        providerPersonalQRCode: 'Personal QR Code',
        ...
        field_alipayQr: 'Alipay QR payload',
        field_wxpayQr: 'WeChat QR payload',
        field_accountName: 'Collection account label',
        field_notifySecret: 'Notification Secret',
        field_matchingMode: 'Matching Mode',
        field_amountWindowCents: 'Amount Window (cents)',
        field_personalQrHint: 'Paste the QR code payload, payment URL, or an image URL. This provider uses admin manual confirmation by default.',
      ...
      rectifier: {
        ...
        thinkingBudgetHint: 'Automatically set budget to 32000 and retry when upstream returns budget_tokens constraint error (�?024)',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        ...
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Sub2API is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li><b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li><b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li><b>Key Distribution</b> - Generate independent API Keys for users</li><li><b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let us complete the initial setup in 3 minutes.</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to Sub2API',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the Sub2API AI service platform.</p><p style="margin-bottom: 12px;"><b>Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>Create API Key</li><li>Copy key to your application</li><li>Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let us get started.</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    storeKicker: 'Account Store',
    storeTitle: 'Store',
    storeSubtitle: 'Choose a balance top-up or subscription plan. Account details and recent orders update on the right.',
    storeSummaryBalance: 'Balance',
    storeSummaryPlans: 'Plans',
    storeSummaryActive: 'Active',
    storeSummaryOrders: 'Recent',
    recentOrders: 'Recent Orders',
    ordersEmpty: 'No recent orders',
    noPlans: 'No subscription plans available',
    subscriptionMarketplace: 'Subscription Plans',
    availablePlans: 'Available Plans',
    balancePayment: 'Balance Payment',
    balanceAvailable: 'Available',
    balanceShortfall: 'Short {amount}',
    balanceShortfallLabel: 'Shortfall',
    balanceAfterPurchase: 'Balance After Purchase',
    balanceInsufficientWithShortfall: 'Balance is short by {amount}.',
    useBalanceSubscribe: 'Use Balance',
    rechargeShortfallAction: 'Recharge',
    externalPaymentSubscribe: 'Pay Externally',
    balanceSubscribeSuccess: 'Subscription purchased for {amount}. Balance: {balance}.',
    balanceSubscribeFailed: 'Failed to purchase subscription with balance',
    ...
    errors: {
      ...
      BALANCE_SUBSCRIPTION_UNAVAILABLE: 'Balance subscription purchase is unavailable.',
      ...
      INVALID_PAYMENT_METHOD: 'Payment method must be Alipay or WeChat Pay.',
      PAYMENT_METHOD_MISMATCH: 'Payment method does not match the order.',
      INVALID_PROVIDER: 'This order is not a personal QR-code payment.',
      RECEIPT_REQUIRED: 'Receipt reference is required.',
      PAYMENT_AMOUNT_MISMATCH: 'Paid amount does not match the order.',
      MANUAL_REFUND_REFERENCE_REQUIRED: 'Manual original-route refund reference is required.',
      REFUND_FAILED: 'Refund failed.',
      EXTERNAL_FULFILLMENT_SKU_ID_INVALID: 'Invalid SKU ID.',
      EXTERNAL_FULFILLMENT_SKU_NOT_FOUND: 'SKU mapping not found.',
      EXTERNAL_ORDER_ID_REQUIRED: 'platform_order_id is required.',
      EXTERNAL_SKU_CODE_REQUIRED: 'sku_code is required.',
      EXTERNAL_FULFILLMENT_ID_INVALID: 'Invalid fulfillment ID.',
      EXTERNAL_FULFILLMENT_NOT_FOUND: 'Fulfillment not found.',
      EXTERNAL_FULFILLMENT_MESSAGE_EMPTY: 'Delivery message is empty.',
      EXTERNAL_FULFILLMENT_REDEEM_UNCONFIGURED: 'Redeem service is not configured.',
      EXTERNAL_FULFILLMENT_TX_REQUIRED: 'Fulfillment transaction is missing.',
      EXTERNAL_REDEEM_VALUE_REQUIRED: 'redeem_value is required.',
      EXTERNAL_REDEEM_GROUP_REQUIRED: 'group_id is required for subscription redeem.',
      EXTERNAL_REDEEM_VALIDITY_REQUIRED: 'validity_days is required for subscription redeem.',
      EXTERNAL_REDEEM_TYPE_INVALID: 'Invalid redeem type.',
    },
    ...
    admin: {
      ...
      operator: 'Operator',
      manualConfirmPayment: 'Confirm Payment',
      personalQrConfirmHint: 'Confirm only after you have verified the matching Alipay/WeChat receipt in the collection account.',
      confirmAmount: 'Received Amount',
      receiptReference: 'Receipt Reference',
      receiptReferencePlaceholder: 'Platform receipt ID, transfer note, or bill reference',
      note: 'Note',
      manualConfirmNotePlaceholder: 'Optional reconciliation note',
      confirmReceived: 'Confirm Received',
      manualConfirmSuccess: 'Payment confirmed',
      personalQrRefundHint: 'Personal QR-code orders require a manual original-route refund in Alipay/WeChat first. Enter the external refund reference before marking it refunded here.',
      manualRefundReference: 'Original-route Refund Reference',
      manualRefundReferencePlaceholder: 'Refund receipt ID or original transaction refund reference',
      ...
      selectGroup: 'Select a group',
      groupRequired: 'Please select a subscription group',
      noSubscriptionGroupsTitle: 'No subscription groups available',
      noSubscriptionGroupsDesc: 'Create an active group with billing type "Subscription" in Group Management first, then return here to create an on-sale plan.',
      noSubscriptionGroupsDialogHint: 'Create an active subscription group in Group Management before creating a plan.',
      launchChecklistTitle: 'Store launch checklist',
      launchChecklistDesc: 'Complete these settings before opening the store so users do not see empty plans or blocked top-ups.',
      launchReady: 'Ready',
      launchNeedsSetup: 'Needs setup',
      launchDone: 'Done',
      launchPending: 'Pending',
      launchBlocked: 'Finish previous step',
      launchSubscriptionGroupTitle: 'Subscription group',
      launchSubscriptionGroupDesc: 'Create an active group with billing type "Subscription" so plans can grant access.',
      launchSubscriptionGroupAction: 'Open Group Management',
      launchSubscriptionPlanTitle: 'On-sale plan',
      launchSubscriptionPlanDesc: 'Create at least one plan and keep it on sale so users can subscribe in the store.',
      launchSubscriptionPlanAction: 'Create Plan',
      launchPaymentProviderTitle: 'Payment provider',
      launchPaymentProviderDesc: 'Add and enable a provider instance before opening public balance top-ups.',
      launchPaymentProviderAction: 'Open Payment Settings',
    ...
    external: {
      ...
      subtitle: 'Map marketplace orders to redeem codes and delivery messages.',
      fulfillmentTitle: 'Fulfillment Records',
      fulfillmentSubtitle: 'Review generated codes, delivery content, and notification status.',
      createSku: 'Add SKU Mapping',
      editSku: 'Edit SKU Mapping',
      ...
      enabled: 'Enabled',
      skuSearch: 'Search SKUs',
      fulfillmentSearch: 'Search orders / buyers',
      allStatuses: 'All Statuses',
      allNotifyStatuses: 'All Notify Statuses',
      statusLabel: 'Status',
      ...
      notifyFeishu: 'Send Feishu Notification',
      retryNotify: 'Retry Notify',
      notifyRetried: 'Notification retried',
      skuSaved: 'SKU mapping saved',
      skuDeleted: 'SKU mapping deleted',
      fulfillmentCreated: 'Fulfillment created',
      fulfillmentReplayed: 'Existing order reused',
      deleteSku: 'Delete SKU mapping',
      deleteSkuConfirm: 'Delete {name}?',
    },
  },
}
