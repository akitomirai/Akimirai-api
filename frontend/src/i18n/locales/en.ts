export default {
  ...
  keys: {
    ...
    imageGroupBadge: 'GPTImage',
    imageGroupHint: 'For GPTImage, choose a group with image generation enabled.',
    imageGroupSelectedHint: 'This group can be used by GPTImage and OpenAI-compatible image requests.',
    imageGroupUnavailableHint: 'This group is not image-capable. Enable image generation on an OpenAI, Grok, or image group before using GPTImage.',
    usage: 'Usage',
    today: 'Today',
    total: 'Last 30d',
    quota: 'Quota',
    ...
    useKeyModal: {
      ...
      gptImage: {
        title: 'Use with GPTImage',
        description: 'Fill these values in /images. Same-origin usage needs no CORS change; external playground deployments must be allowed in CORS settings.',
        apiUrl: 'API URL',
        apiKey: 'API Key',
        apiMode: 'API mode',
        model: 'Model',
        copyConfig: 'Copy config',
        copied: 'GPTImage config copied',
        open: 'Open GPTImage',
      },
      openai: {
  ...
  usage: {
    ...
    errors: {
      ...
      empty: 'No error requests', disabled: 'Error request records are not enabled', failedToLoad: 'Failed to load error requests',
      categories: {
  ...
  profile: {
    ...
    privacyFilter: {
      title: 'Privacy Filter Protection',
      description: 'When enabled, selected sensitive fragments are replaced before requests are forwarded to upstream AI models.',
      noRetention: 'This platform does not store request content or retain user data.',
      enabled: 'Enable privacy filter protection',
      enabledSuccess: 'Privacy filter protection enabled',
      disabledSuccess: 'Privacy filter protection disabled',
      types: {
        ...
        random_string: 'Unknown Random String',
      },
      hints: {
        ip_address: 'Redact IPv4 / IPv6 addresses',
        email: 'Redact email addresses',
        phone: 'Redact common mobile or phone numbers',
        id_card: 'Redact mainland China ID card numbers',
        bank_card: 'Redact common bank card numbers',
        api_key: 'Redact common AI service API keys',
        token: 'Redact Authorization, access_token, refresh_token, JWT, and similar tokens',
        private_key: 'Redact PEM private key blocks',
        random_string: 'Redact long strings that look like secrets or random tokens',
      },
    },
    // TOTP 2FA
    totp: {
  ...
  admin: {
    ...
    settings: {
      ...
      privacyFilter: {
        title: 'Privacy Filter Protection',
        description: 'Global filtering always applies first; user settings can only add extra filter types for that user.',
        enabled: 'Enable global privacy filter',
        types: {
          ip_address: 'IP Address',
          email: 'Email',
          phone: 'Phone',
