export default {
    ...
    usage: {
      ...
      diagnostics: {
        ...
        retrySwitch: '重试 / 换号',
        timeline: '耗时检查点',
        requestPreparation: '请求准备',
        dnsResolution: 'DNS 解析',
        tcpConnection: 'TCP 连接',
        tlsHandshake: 'TLS 握手',
        connectionReused: '复用连接',
        requestHeadersSent: '请求头发送',
        requestBodySent: '请求体发送',
        waitingResponseHeaders: '等待响应头',
        responseHeadersToFirstByte: '响应头到首字节',
        firstByteToFirstEvent: '首字节到首事件',
        firstEventToFirstCharacter: '首事件到首字',
        afterFirstCharacter: '首字后生成',
        firstCharacterLatency: '首字延迟',
        endToEndTotal: '端到端总耗时',
        bodyRead: '读取请求体',
        routing: '路由选择',
        requestWritten: '写完上游请求',
        firstByte: '收到上游响应头',
