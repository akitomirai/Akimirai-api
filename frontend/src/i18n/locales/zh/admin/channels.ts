export default {
    ...
    modelPricing: {
      title: '模型定价',
      description: '按模型查看由渠道配置持有的定价规则。',
      channelConfiguration: '渠道配置',
      searchPlaceholder: '搜索模型或来源渠道...',
      allProviders: '全部供应商',
      allBillingModes: '全部计费方式',
      allStatuses: '全部状态',
      resultCount: '共 {count} 个模型',
      sourceOfTruth: '定价仍由渠道配置统一管理。',
      loadError: '加载模型定价失败。',
      empty: '暂无模型定价',
      emptyHint: '请前往渠道配置添加定价规则。',
      noMatches: '没有符合当前筛选条件的模型',
      noMatchesHint: '调整或重置筛选条件以查看更多模型。',
      pattern: '通配模式',
      priceSummary: '价格摘要',
      sourceCount: '{count} 条来源规则',
      disabledSourceCount: '{count} 条已停用',
      details: '详情',
      mixedPricingSummary: '{count} 条规则 / 混合计费',
      tieredOrUnset: '阶梯定价或未设置',
      imageUnit: '张',
      requestUnit: '次请求',
      detailsTitle: '模型定价详情',
      provider: '供应商',
