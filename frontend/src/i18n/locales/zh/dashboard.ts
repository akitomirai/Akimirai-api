export default {
  ...
  keys: {
    ...
    modelRestriction: {
      label: '模型限制',
      placeholder: '选择模型（留空表示允许所有）',
      hint: '仅允许所选模型使用此密钥；留空则允许分组内全部模型。',
      loading: '正在加载可用模型...',
      loadFailed: '模型目录加载失败，仍可保存空白限制。',
      search: '搜索模型...',
      noMatch: '未找到匹配模型',
      empty: '该分组暂无目录模型',
      clear: '清空选择',
      remove: '移除 {model}',
      removedAfterGroupChange: '已移除新分组不可用的 {count} 个模型。',
      groupChangeBlocked: '模型目录暂不可用，无法安全切换已有模型限制的密钥分组，请稍后重试。'
    },
    ccsImport: {
      title: '填入 CC Switch',
      app: '应用',
  ...
  usage: {
    ...
    apiKeyFilter: 'API 密钥',
    allApiKeys: '全部密钥',
    apiKeyDistribution: '按 API 密钥分布',
    apiKeyFallback: '密钥 #{id}',
    user: '用户',
    userDistribution: '按用户分布',
    userFallback: '用户 #{id}',
    timeRange: '时间范围',
    exportCsv: '导出 CSV',
  ...
  profile: {
    ...
    avatar: {
      ...
      qqLoading: '正在检查 QQ 邮箱头像...',
      qqCheckAction: '检查 QQ 头像',
      qqConsentHint: '点击检查后才会加载 QQ 头像预览。',
      qqTitle: 'QQ 邮箱头像',
      qqHint: '检测到 QQ 号 {qq} 对应的头像',
      qqUseAction: '使用 QQ 头像',
      qqCurrent: '正在使用',
      qqLoadFailed: '检查 QQ 头像失败',
      qqUnavailable: '未检测到可用的 QQ 头像',
      qqImageFailed: '暂时无法预览 QQ 头像',
      qqPreviewAlt: 'QQ 头像预览',
    },
    privacyFilter: {
      title: '隐私信息过滤',
      description: '自动识别并隐藏请求中的常见敏感信息。',
      noRetention: '过滤仅在请求转发时进行，不额外保存原始敏感内容。',
      enabled: '启用隐私信息过滤',
      enabledSuccess: '隐私信息过滤已启用',
      disabledSuccess: '隐私信息过滤已关闭',
      types: {
        ip_address: 'IP 地址',
        email: '邮箱',
        phone: '手机号',
      ...
      hints: {
        ip_address: '识别 IPv4 和 IPv6 地址',
        email: '识别常见邮箱地址',
        phone: '识别常见手机号码',
        id_card: '识别身份证号码',
        bank_card: '识别常见银行卡号码',
        api_key: '识别常见 API Key 格式',
        token: '识别 Bearer Token 等访问令牌',
        private_key: '识别 PEM 等私钥内容',
        random_string: '识别高随机度的疑似凭证字符串',
      },
    },
    authBindings: {
      title: '登录方式绑定',
