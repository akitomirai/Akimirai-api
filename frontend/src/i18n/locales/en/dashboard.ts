export default {
  dashboard: {
    ...
    metricType: 'Y-axis metric',
    quotaConsumption: 'Quota spend',
    actualConsumption: 'Actual spend',
    barChart: 'Bar',
    areaChart: 'Area',
    other: 'Other',
  ...
  keys: {
    ...
    endpoints: {
      ...
      externalSpeedTest: 'External speed test',
    },
    ...
    modelRestriction: {
      ...
      placeholder: 'Select models (leave empty to allow all)',
      hint: 'Only selected models can use this key. Leave empty to allow every model in the group.',
      loading: 'Loading available models...',
      loadFailed: 'Failed to load the model catalog. You can still save an empty restriction.',
      search: 'Search models...',
      noMatch: 'No matching models',
      empty: 'This group has no catalog models',
      clear: 'Clear selection',
      remove: 'Remove {model}',
      removedAfterGroupChange: 'Removed {count} model(s) that are unavailable in the new group.',
      groupChangeBlocked: 'The model catalog is unavailable, so this restricted key cannot safely change groups. Please retry after the catalog loads.',
    },
    ccsImport: {
      ...
      remoteCompactionHint: 'When enabled, the CC Switch provider name is set to OpenAI.',
    },
  ...
  usage: {
    ...
    logs: {
      ...
      noGroup: 'No group',
      empty: 'No API logs found for the selected filters',
      failedToLoad: 'Failed to load API logs',
      detailTitle: 'Log Details',
      detailLoadFailed: 'Failed to load log details, please try again',
  ...
  profile: {
    ...
    avatar: {
      ...
      qqConsentHint: 'The QQ avatar preview loads only after you click check.',
      qqTitle: 'QQ Email Avatar',
      qqHint: 'Avatar detected for QQ number {qq}',
      qqUseAction: 'Use QQ avatar',
      qqCurrent: 'In use',
      qqLoadFailed: 'Failed to check QQ avatar',
      qqUnavailable: 'No available QQ avatar was detected',
      qqImageFailed: 'QQ avatar cannot be previewed right now',
      qqPreviewAlt: 'QQ avatar preview',
    },
    privacyFilter: {
      title: 'Privacy Filter',
      description: 'Automatically detect and hide common sensitive values in requests.',
      noRetention: 'Filtering happens during forwarding without retaining the original sensitive content.',
      enabled: 'Enable privacy filtering',
      enabledSuccess: 'Privacy filtering enabled',
      disabledSuccess: 'Privacy filtering disabled',
      types: {
        ...
        random_string: 'Random secret',
      },
      hints: {
        ip_address: 'Detect IPv4 and IPv6 addresses',
        email: 'Detect common email addresses',
        phone: 'Detect common phone numbers',
        id_card: 'Detect identity document numbers',
        bank_card: 'Detect common bank card numbers',
        api_key: 'Detect common API key formats',
        token: 'Detect bearer tokens and similar access tokens',
        private_key: 'Detect PEM and similar private-key content',
        random_string: 'Detect high-entropy strings that may be credentials',
      },
    },
    authBindings: {
