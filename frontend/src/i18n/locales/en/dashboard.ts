export default {
  ...
  keys: {
    ...
    ccsImport: {
      ...
      remoteCompactionHint: 'CC Switch enables Codex remote compaction through the OpenAI provider name.',
      remoteCompactionNameHint: 'The provider will be named OpenAI; CC Switch 3.16.x (#3751) rebuilds Codex TOML when saving and cannot preserve arbitrary custom fields.',
    },
