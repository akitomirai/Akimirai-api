export default {
  ...
  payment: {
    ...
    tabOrders: 'Orders',
    balanceInsufficientWithShortfall: 'Add {amount} to continue with balance payment.',
    balanceSubscribeSuccess: 'Subscription activated. Charged {amount}; balance {balance}.',
    balanceSubscribeFailed: 'Balance subscription failed.',
