export default {
    ...
    modelPricing: {
      title: 'Model Pricing',
      description: 'View channel-owned pricing rules grouped by model.',
      channelConfiguration: 'Channel Configuration',
      searchPlaceholder: 'Search models or source channels...',
      allProviders: 'All providers',
      allBillingModes: 'All billing modes',
      allStatuses: 'All statuses',
      resultCount: '{count} model(s)',
      sourceOfTruth: 'Pricing remains owned by channel configuration.',
      loadError: 'Failed to load model pricing.',
      empty: 'No model pricing configured',
      emptyHint: 'Add pricing rules from channel configuration.',
      noMatches: 'No models match the current filters',
      noMatchesHint: 'Adjust or reset the filters to see more models.',
      pattern: 'Pattern',
      priceSummary: 'Price summary',
      sourceCount: '{count} source rule(s)',
      disabledSourceCount: '{count} disabled',
      details: 'Details',
      mixedPricingSummary: '{count} rules / mixed billing',
      tieredOrUnset: 'Tiered or unset',
      imageUnit: 'image',
      requestUnit: 'request',
      ...
      platform: 'Platform',
      billingMode: 'Billing mode',
      modelSource: 'Pricing lookup',
      restrictModels: 'Restricted models',
      sharedModels: 'Models sharing this rule',
