export default {
    ...
    usage: {
      ...
      diagnostics: {
        ...
        totalDuration: 'End-to-end total',
        ...
        requestPreparation: 'Request preparation',
        dnsResolution: 'DNS resolution',
        tcpConnection: 'TCP connection',
        tlsHandshake: 'TLS handshake',
        connectionReused: 'Reused connection',
        requestHeadersSent: 'Request headers sent',
        requestBodySent: 'Request body sent',
        waitingResponseHeaders: 'Waiting for response headers',
        responseHeadersToFirstByte: 'Response headers to first byte',
        firstByteToFirstEvent: 'First byte to first event',
        firstEventToFirstCharacter: 'First event to first character',
        afterFirstCharacter: 'Generation after first character',
        firstCharacterLatency: 'First-character latency',
        endToEndTotal: 'End-to-end total',
        bodyRead: 'Request body read',
        routing: 'Routing',
        requestWritten: 'Upstream request written',
        firstByte: 'Upstream response headers',
