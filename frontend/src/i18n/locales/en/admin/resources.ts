export default {
    ...
    usage: {
      ...
      diagnostics: {
        ...
        open: 'Open request diagnostics',
        loadFailed: 'Failed to load request diagnostics',
        retry: 'Retry',
        route: 'Route',
        ...
        proxyId: 'Proxy ID',
        proxyFallback: 'Proxy',
        retryOnly: 'Retries only',
        minTotalMs: 'Min total (ms)',
        minFirstTokenMs: 'Min first token (ms)',
        minFirstByteMs: 'Min first byte (ms)',
        requestStartedAt: 'Request started',
        recordedAt: 'Record completed',
        totalDuration: 'Request processing total',
        ...
        promptCacheKeySource: 'Identity source',
        promptCacheKeyHash: 'Identity hash',
        promptCachePrefixHash: 'Stable prefix hash',
        promptCacheToolsHash: 'Tools hash',
        promptCacheSystemHash: 'System hash',
        promptCacheSource: {
          none: 'Not provided',
          client_header: 'Client session header',
          client_body: 'Client prompt_cache_key',
          compat_derived: 'Compatibility-derived key'
        },
        retrySwitch: 'Retries / switches',
        timeline: 'Timing checkpoints',
        timelineDetail: 'Key metrics by business stage; values may be stage durations or elapsed time from request start.',
        bodyRead: 'Request body read',
        bodyReadDetail: 'Time spent reading the client request body itself; not elapsed from request start',
        routing: 'Routing',
        routingDetail: 'Cumulative time from entering routing to the final upstream attempt; includes concurrency waits, billing rechecks, and retry effects',
        requestWritten: 'Upstream request write completed',
        requestWrittenDetail: 'On the final upstream attempt, elapsed time until the HTTP client completed its request write flow; this does not prove receipt',
        firstByte: 'Upstream response header first byte',
        firstByteDetail: 'On the final upstream attempt, elapsed time until the first response-header byte was available; not body data or a model token',
        firstToken: 'First semantic token',
        firstTokenDetail: 'The upstream forwarder\'s first-token metric converted to request-start elapsed time; detection varies by protocol',
        completed: 'Request completed',
        completedDetail: 'Elapsed time from request handling start through upstream forwarding and response processing, captured before async usage persistence',
        bodyBytes: 'Request body size',
        attempts: 'Retry and switch attempts',
        startedOffset: 'Started',
        writtenOffset: 'Written',
        firstByteOffset: 'Response headers',
        status: 'Status',
        unavailable: 'Unavailable',
        viewErrors: 'View matching errors'
      },
      tokenRanking: {
