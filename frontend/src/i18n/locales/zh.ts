export default {
  ...
  auth: {
    welcomeBack: '欢迎回来',
    layoutHeroKicker: 'Akimirai 控制平面',
    layoutHeroTitle: '让每一次请求清晰落地。',
    layoutHeroDescription: '为重视稳定访问、用量可见和成本可控的团队准备的安静网关。',
    layoutHeroMetricOneValue: '1 Key',
    layoutHeroMetricOneLabel: '统一入口',
    layoutHeroMetricTwoValue: 'Quota',
    layoutHeroMetricTwoLabel: '配额护栏',
    layoutHeroMetricThreeValue: 'Live',
    layoutHeroMetricThreeLabel: '实时信号',
