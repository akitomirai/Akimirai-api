export default {
  ...
  quickStart: {
    kicker: '接入配置',
    title: '快速接入',
    description: '集中复制兼容 OpenAI 的最小配置，并从同一入口查看模型、用量和错误。',
    baseUrl: 'Base URL',
    model: 'Model',
    apiKey: 'API Key',
    ...
    viewUsage: '用量',
    viewErrors: '错误记录',
    loadFailed: '快速接入数据加载失败，请刷新后重试。',
    placeholderKeyHint: '普通页面只展示占位符。创建 Key 后可一次性复制真实值。',
    oneTimeKeyHint: '此 Key 仅在创建结果中可见，请立即复制并妥善保存。',
    curlExample: 'curl',
    openaiSdkExample: 'OpenAI SDK',
    codexExample: 'Codex',
    commonErrors: '常见错误',
    commonErrorsHint: '打开用量错误记录可查看完整排障建议。',
    errors: {
      '403': '余额不足或订阅不可用。',
      '429': '触发限流，请降低并发或稍后重试。',
      '502': '上游失败。',
      '503': '暂无可用渠道。',
      streamDisconnected: '流式连接在完成前中断。'
    }
  },

  // Auth
  auth: {
    welcomeBack: '欢迎回到神社，投币开门。',
    layoutBrandName: 'Bakaai',
    layoutHeroKicker: '幻想乡 API 中转所',
    layoutHeroTitle: 'Bakaai',
    layoutHeroSubtitle: '各路大模型，一键投币祈愿。',
    layoutHeroDescription: '汇聚Claude、GPT、Gemini等各路神明显灵。',
    layoutHeroMetricOneValue: 'API',
    layoutHeroMetricOneLabel: '统一中转',
    layoutHeroMetricTwoValue: 'Multi',
    layoutHeroMetricTwoLabel: '平台聚合',
    layoutHeroMetricThreeValue: 'Ledger',
    layoutHeroMetricThreeLabel: '用量账本',
    ...
    emailRequired: '请输入邮箱',
    invalidEmail: '请输入有效的邮箱地址',
    emailLocalPartNotAllowed: '该邮箱前缀不支持注册，请更换其他邮箱地址。',
  ...
  dashboard: {
    ...
    commercial: {
      balanceTitle: '当前余额',
      loadFailed: '控制台数据加载失败，主要入口仍可使用。',
      noBalance: '暂无余额数据',
      recharge: '充值',
      redeem: '兑换',
      todayUsageTitle: '今日消耗',
      noTodayStats: '暂无今日统计',
      requests: '次请求',
      viewUsage: '查看用量',
      keyStatusTitle: 'API Key 状态',
      keyLoadFailed: 'Key 状态加载失败',
      lastUsedAt: '最近使用 {time}',
      noKeyUsage: '暂无最近使用记录',
      createKey: '创建 API Key',
      manageKeys: '管理 API Key',
      quickStartTitle: '新手接入',
      quickStartDescription: '从这里复制 Base URL、创建 Key、选择模型，并进入用量或错误记录。',
      copyBaseUrl: '复制 Base URL',
      viewQuickStart: '查看接入配置',
      viewModels: '查看模型',
      paymentTitle: '充值与套餐',
      paymentEnabled: '充值、订单记录和订阅入口已可用。',
      paymentDisabled: '充值系统未开启，可使用兑换码入口。',
      orders: '订单记录',
      subscriptions: '套餐/订阅',
      recentErrorsTitle: '最近错误',
      recentErrorsDescription: '这里只展示面向用户的安全错误字段。',
      viewErrors: '查看错误',
      errorViewDisabled: '用户错误记录入口未开启。',
      errorLoadFailed: '最近错误加载失败。',
      noRecentErrors: '暂无失败请求。',
  ...
  keys: {
    ...
    copied: '已复制！',
    keyShownOnce: 'API 密钥仅在创建后显示一次。如需完整密钥，请创建新的密钥。',
    integrationExamples: {
      title: '接入配置示例',
      subtitle: '使用占位 Key 配置 OpenAI SDK、Codex、Cursor 或 Cherry Studio。',
      copyBaseUrl: '复制 Base URL',
      copyExample: '复制示例',
      copied: '接入配置已复制',
    },
    ...
    useKeyModal: {
      ...
      copy: '复制',
      copied: '已复制',
      immediateCopyNotice: '请立即复制保存这个 API Key，关闭后无法再次查看完整密钥。',
      keyName: 'Key 名称',
      keyPrefix: 'Prefix / masked',
      copyApiKey: '复制 API Key',
      copyBaseUrl: '复制 Base URL',
      nextQuickStart: '下一步：查看接入配置',
      viewUsage: '查看用量',
  ...
  usage: {
    ...
    clientTransport: '入站协议',
    authLatency: '认证',
    routingLatency: '路由调度',
    upstreamLatency: '上游响应',
    responseLatency: '响应传输',
    ws: 'WS',
    stream: '流式',
    sync: '非流式',
    cyber: '安全策略',
    ...
    errors: {
      ...
      category: '分类', platform: '平台', message: '错误信息', explanation: '说明',
      suggestion: '建议', retryable: '可重试', notRetryable: '不可重试',
      charged: '可能计费', notCharged: '通常不计费', errorCode: '错误码',
      requestId: 'Request ID',
  ...
  profile: {
    ...
    avatar: {
      ...
      qqTitle: 'QQ 邮箱头像',
      qqHint: '已识别 QQ 号 {qq}，可选择使用公开 QQ 头像',
      qqLoading: '正在检测 QQ 邮箱头像...',
      qqCheckAction: '检测 QQ 头像',
      qqConsentHint: '点击检测后，将根据 QQ 邮箱识别 QQ 号并从 QQ 公开头像服务加载预览。',
      qqUseAction: '使用 QQ 头像',
      qqCurrent: '已使用',
      qqLoadFailed: '检测 QQ 头像失败',
      qqUnavailable: '当前账号未检测到可用 QQ 头像',
      qqImageFailed: 'QQ 头像暂时无法预览，请继续使用上传头像',
      qqPreviewAlt: 'QQ 头像预览',
    },
    authBindings: {
      title: '登录方式绑定',
  ...
  admin: {
    ...
    riskControl: {
      ...
      modeObserve: '仅观察',
      modeObserveDesc: '请求直接放行，最新用户输入进入异步审核队列；命中后记录日志，邮件和封禁累计仅在对应开关开启时执行。',
      modeOff: '关闭',
      ...
      emailOnHit: '命中后发送邮件',
      emailOnHitHint: '默认关闭。开启后才会向用户发送风控提醒邮件；关闭时仅拦截请求并记录后台日志。',
      autoBan: '自动封禁用户',
      autoBanHint: '默认关闭。开启后命中次数达到阈值才会禁用用户账号；关闭时不会自动封禁或踢下线。',
      cyberPolicyExcludeBan: 'cyber_policy 不计入封号次数',
      cyberPolicyExcludeBanHint: '开启后，cyber_policy 拦截不计入自动封号的违规次数。邮件通知仍受“命中后发送邮件”开关控制。',
      ...
      blockedKeywordsDescription: '默认只放明确滥用动作词；正常开发、运维、合法 API、防御教学、CTF 和无害自动化不应仅因主题词被拦截。',
      ...
      blockedKeywordsLimit: '最多保存 {max} 个关键词，单个长度不超过 200 个字符；重复项会自动去重，过宽词请改成带动作和意图的词组。',
    ...
    ops: {
      ...
      openaiTokenStats: {
        ...
        subtitle: '基于 usage_logs 按模型汇总缓存读取率、首 Token 和输出速度。',
        viewModeTopN: 'TopN',
        ...
        optimizationTitle: '优化信号',
        metrics: {
          cacheReadRatio: '缓存读取率',
          cacheReadCaption: '复用了 {tokens} 个缓存输入 Token',
          avgFirstToken: '平均首 Token',
          firstTokenCaption: '当前切片共 {requests} 次请求',
          avgTokensPerSec: '平均输出速度',
          tokensPerSecCaption: '按请求数加权'
        },
        tips: {
          lowCacheRead: '该流量切片的缓存读取率偏低。尽量把稳定的系统提示词、工具 schema 和可复用上下文放在请求开头，让相同前缀可复用。',
          cacheWriteHeavy: '缓存写入明显高于读取。检查请求前缀是否频繁变化，或用户是否把大段动态上下文放在可复用前缀之前。',
          highFirstToken: '首 Token 延迟偏高。优先检查上游账号健康、模型选择、提示词长度和流式路径，再调整应用侧重试。',
          healthy: '当前切片的缓存复用和首 Token 延迟看起来正常，继续关注请求数最高的模型行。'
        },
        table: {
          model: '模型',
          requestCount: '请求数',
          ...
          cacheReadRatio: '缓存读取率',
          totalCacheReadTokens: '缓存读取 Token',
          totalCacheCreationTokens: '缓存写入 Token',
    ...
    settings: {
      ...
      payment: {
        ...
        field_alipayQr: '支付宝收款码内容',
        field_wxpayQr: '微信收款码内容',
        field_accountName: '收款账号标识',
        field_notifySecret: '通知密钥',
        field_matchingMode: '匹配模式',
        field_amountWindowCents: '金额窗口（分）',
        field_personalQrHint: '可填写二维码解析内容、收款链接或图片 URL。此服务商默认由后台人工确认到账。',
  ...
  payment: {
    ...
    storeKicker: '账户商城',
    storeTitle: '商城',
    storeSubtitle: '选择余额充值或订阅套餐，账户信息与最近订单会在右侧同步更新。',
    storeSummaryBalance: '当前余额',
    storeSummaryPlans: '可选套餐',
    storeSummaryActive: '有效订阅',
    storeSummaryOrders: '最近订单',
    recentOrders: '最近订单',
    ordersEmpty: '暂无最近订单',
    noPlans: '暂无可用订阅套餐',
    subscriptionMarketplace: '订阅套餐',
    availablePlans: '可选套餐',
    balancePayment: '余额支付',
    balanceAvailable: '可用',
    balanceShortfall: '差 {amount}',
    balanceShortfallLabel: '差额',
    balanceAfterPurchase: '购买后余额',
    balanceInsufficientWithShortfall: '余额还差 {amount}。',
    useBalanceSubscribe: '使用余额订阅',
    rechargeShortfallAction: '去充值',
    externalPaymentSubscribe: '外部支付',
    balanceSubscribeSuccess: '已使用 {amount} 完成订阅，余额 {balance}。',
    ...
    errors: {
      ...
      BALANCE_SUBSCRIPTION_UNAVAILABLE: '余额订阅暂不可用',
      ...
      INVALID_PAYMENT_METHOD: '支付方式必须是支付宝或微信',
      PAYMENT_METHOD_MISMATCH: '支付方式与订单不匹配',
      INVALID_PROVIDER: '该订单不是个人收款码支付',
      RECEIPT_REQUIRED: '请填写到账凭据',
      PAYMENT_AMOUNT_MISMATCH: '到账金额与订单不匹配',
      MANUAL_REFUND_REFERENCE_REQUIRED: '请填写原路退款凭据',
      REFUND_FAILED: '退款失败',
      EXTERNAL_FULFILLMENT_SKU_ID_INVALID: 'SKU ID 无效',
      EXTERNAL_FULFILLMENT_SKU_NOT_FOUND: 'SKU 映射不存在',
      EXTERNAL_ORDER_ID_REQUIRED: '平台订单号不能为空',
      EXTERNAL_SKU_CODE_REQUIRED: 'SKU 编号不能为空',
      EXTERNAL_FULFILLMENT_ID_INVALID: '履约 ID 无效',
      EXTERNAL_FULFILLMENT_NOT_FOUND: '履约记录不存在',
      EXTERNAL_FULFILLMENT_MESSAGE_EMPTY: '发货内容不能为空',
      EXTERNAL_FULFILLMENT_REDEEM_UNCONFIGURED: '兑换服务未配置',
      EXTERNAL_FULFILLMENT_TX_REQUIRED: '履约事务缺失',
      EXTERNAL_REDEEM_VALUE_REQUIRED: '兑换值不能为空',
      EXTERNAL_REDEEM_GROUP_REQUIRED: '订阅兑换需要分组 ID',
      EXTERNAL_REDEEM_VALIDITY_REQUIRED: '订阅兑换需要有效期',
      EXTERNAL_REDEEM_TYPE_INVALID: '兑换类型无效',
    },
    ...
    admin: {
      ...
      auditLogs: '操作日志',
      operator: '操作人',
      manualConfirmPayment: '确认到账',
      personalQrConfirmHint: '请先在支付宝/微信收款账户中核对到账记录，确认金额与订单一致后再标记到账。',
      confirmAmount: '到账金额',
      receiptReference: '到账凭据',
      receiptReferencePlaceholder: '平台账单号、转账备注或收款记录编号',
      note: '备注',
      manualConfirmNotePlaceholder: '可填写对账备注',
      confirmReceived: '确认已到账',
      manualConfirmSuccess: '已确认到账',
      personalQrRefundHint: '个人收款码订单需要先在支付宝/微信中对原交易执行原路退款，再在这里填写外部退款凭据并标记完成。',
      manualRefundReference: '原路退款凭据',
      manualRefundReferencePlaceholder: '退款账单号或原交易退款记录编号',
      channelName: '渠道名称',
      ...
      selectGroup: '请选择分组',
      groupRequired: '请选择订阅分组',
      noSubscriptionGroupsTitle: '暂无可用订阅分组',
      noSubscriptionGroupsDesc: '请先在分组管理中创建一个启用状态、计费类型为“订阅”的分组，然后回到这里创建上架套餐。',
      noSubscriptionGroupsDialogHint: '创建套餐前，请先在分组管理中创建启用状态的订阅分组。',
      launchChecklistTitle: '商城上线检查',
      launchChecklistDesc: '开放商城前请完成以下配置，避免用户看到空套餐或无法充值。',
      launchReady: '已就绪',
      launchNeedsSetup: '待配置',
      launchDone: '已完成',
      launchPending: '未完成',
      launchBlocked: '先完成前置项',
      launchSubscriptionGroupTitle: '订阅分组',
      launchSubscriptionGroupDesc: '创建启用状态、计费类型为“订阅”的分组，用于承载套餐权限。',
      launchSubscriptionGroupAction: '前往分组管理',
      launchSubscriptionPlanTitle: '上架套餐',
      launchSubscriptionPlanDesc: '至少创建一个套餐并开启上架，用户才能在商城订阅。',
      launchSubscriptionPlanAction: '创建套餐',
      launchPaymentProviderTitle: '支付服务商',
      launchPaymentProviderDesc: '公开余额充值前需要添加并启用一个支付服务商实例。',
      launchPaymentProviderAction: '前往支付设置',
    ...
    external: {
      title: '兑换履约',
      subtitle: '将外部平台订单映射为兑换码，并写入发货内容。',
      fulfillmentTitle: '履约记录',
      fulfillmentSubtitle: '查看已生成的兑换码、发货内容和通知状态。',
      createSku: '新增 SKU 映射',
      editSku: '编辑 SKU 映射',
      createFulfillment: '创建履约',
      platform: '平台',
      allPlatforms: '全部平台',
      platformXianyu: '闲鱼',
      skuCode: 'SKU 编号',
      ...
      redeemTypeSubscription: '订阅',
      redeemTypeInvitation: '邀请',
      redeemValue: '兑换值',
      groupId: '分组 ID',
      validityDays: '有效期（天）',
      expiresInDays: '过期时间（天）',
      manualUrl: '手动链接',
      deliveryTemplate: '发货模板',
      enabled: '启用',
      skuSearch: '搜索 SKU',
      fulfillmentSearch: '搜索订单 / 买家',
      allStatuses: '全部状态',
      allNotifyStatuses: '全部通知状态',
      statusLabel: '状态',
      notifyStatus: '通知状态',
      status: {
        pending: '待处理',
      ...
      notifyRetried: '通知已重试',
      skuSaved: 'SKU 映射已保存',
      skuDeleted: 'SKU 映射已删除',
      fulfillmentCreated: '履约记录已创建',
      fulfillmentReplayed: '已复用现有订单',
      deleteSku: '删除 SKU 映射',
      deleteSkuConfirm: '确认删除 {name} 吗？',
    },
  },
}
