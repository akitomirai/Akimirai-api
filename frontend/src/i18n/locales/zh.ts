export default {
  ...
  keys: {
    ...
    imageGroupHint: '用于 GPTImage 时，请选择已开启图片生成的分组。',
    imageGroupSelectedHint: '该分组可用于 GPTImage 和 OpenAI 兼容图片接口。',
    imageGroupUnavailableHint: '该分组暂不支持生图。请先选择已开启图片生成的 OpenAI、Grok 或 Image 分组。',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
    ...
    useKeyModal: {
      ...
      gptImage: {
        title: '用于 GPTImage',
        description: '将这些值填入 /images。同源使用无需调整 CORS；如果使用外部 playground，请在 CORS 设置中放行对应域名。',
        apiUrl: 'API URL',
        apiKey: 'API Key',
        apiMode: 'API mode',
        model: '模型',
        copyConfig: '复制配置',
        copied: 'GPTImage 配置已复制',
        open: '打开 GPTImage'
      },
      openai: {
  ...
  usage: {
    ...
    errors: {
      ...
      empty: '暂无错误请求', disabled: '错误请求记录入口未开启', failedToLoad: '加载错误请求失败',
      categories: {
  ...
  profile: {
    ...
    privacyFilter: {
      title: '隐私过滤保护',
      description: '开启后，请求转发到原厂 AI 模型前会按选择的类型替换敏感片段。',
      noRetention: '本平台不保存请求内容，不留存用户数据。',
      enabled: '启用隐私过滤保护',
      enabledSuccess: '已开启隐私过滤保护',
      disabledSuccess: '已关闭隐私过滤保护',
      types: {
        ip_address: 'IP 地址',
        email: '邮箱',
        phone: '手机号',
      ...
      hints: {
        ip_address: '过滤 IPv4 / IPv6 地址',
        email: '过滤邮箱地址',
        phone: '过滤常见手机或电话号码',
        id_card: '过滤中国大陆身份证号码',
        bank_card: '过滤常见银行卡号',
        api_key: '过滤常见 AI 服务 API Key',
        token: '过滤 Authorization、access_token、refresh_token、JWT 等',
        private_key: '过滤 PEM 私钥块',
        random_string: '过滤疑似密钥或随机令牌的长字符串',
      },
    },
    // TOTP 2FA
    totp: {
  ...
  admin: {
    ...
    settings: {
      ...
      privacyFilter: {
        title: '隐私过滤保护',
        description: '全局过滤始终优先生效；用户个人设置只能额外增加自己的过滤类型。',
        enabled: '启用全局隐私过滤',
        types: {
          ip_address: 'IP 地址',
          email: '邮箱',
