...
func (s *AccountRepoSuite) TestUpdateWithEncryptedCredentialsPreservesBillingProbeWhenIdentityIsUnchanged() {
	s.repo.credentialEncryptor = newTestAccountEncryptor(s.T())
	account := &service.Account{
		Name:        "encrypted-probe-update",
		Platform:    service.PlatformOpenAI,
		Type:        service.AccountTypeAPIKey,
		Status:      service.StatusActive,
		Schedulable: true,
		Credentials: map[string]any{"api_key": "sk-encrypted-probe"},
		Extra: map[string]any{
...
func (s *AccountRepoSuite) TestCreateWithAccountGroupsEncryptsCredentials() {
	s.repo.credentialEncryptor = newTestAccountEncryptor(s.T())
	account := &service.Account{
		Name:        "encrypted-duplicate-path",
		Platform:    service.PlatformOpenAI,
		Type:        service.AccountTypeAPIKey,
		Status:      service.StatusDisabled,
		Schedulable: false,
		Credentials: map[string]any{"api_key": "sk-duplicate-secret"},
		Extra:       map[string]any{},
	}
