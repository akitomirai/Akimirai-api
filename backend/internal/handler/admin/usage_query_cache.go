...
type usageStatsCacheKeyData struct {
	...
	RetryOnly              bool   `json:"retry_only"`
	MinRequestTotalMs      *int   `json:"min_request_total_ms"`
	MinRequestFirstTokenMs *int   `json:"min_request_first_token_ms"`
	MinUpstreamFirstByteMs *int   `json:"min_upstream_first_byte_ms"`
}
...
func usageStatsCacheKey(filters usagestats.UsageLogFilters) string {
	...
	return mustMarshalDashboardCacheKey(usageStatsCacheKeyData{
		...
		MinRequestTotalMs:      filters.MinRequestTotalMs,
		MinRequestFirstTokenMs: filters.MinRequestFirstTokenMs,
		MinUpstreamFirstByteMs: filters.MinUpstreamFirstByteMs,
	})
}
