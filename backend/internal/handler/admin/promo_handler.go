...
type CreatePromoCodeRequest struct {
	...
	DiscountPercent float64 `json:"discount_percent" binding:"min=0,max=99.99"` // 支付折扣比例
...
type UpdatePromoCodeRequest struct {
	...
	DiscountPercent *float64 `json:"discount_percent" binding:"omitempty,min=0,max=99.99"`
