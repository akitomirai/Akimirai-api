...
type CreateAccountRequest struct {
	...
	Type                    string         `json:"type" binding:"required,oneof=oauth setup-token apikey upstream bedrock service_account password"`
...
type UpdateAccountRequest struct {
	...
	Notes                   *string        `json:"notes"`
	Type                    string         `json:"type" binding:"omitempty,oneof=oauth setup-token apikey upstream bedrock service_account password"`
