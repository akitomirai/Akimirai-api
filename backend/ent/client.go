...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.ErrorPassthroughRule, c.ExternalFulfillmentSKU, c.ExternalOrderFulfillment,
...
type (
	hooks struct {
		...
		ChannelMonitorRequestTemplate, ErrorPassthroughRule, ExternalFulfillmentSKU,
		ExternalOrderFulfillment, Group, IdempotencyRecord, IdentityAdoptionDecision,
