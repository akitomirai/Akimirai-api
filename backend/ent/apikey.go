...
type APIKey struct {
	...
	// Versioned hash of the API key secret; new keys should not store plaintext in key
	KeyHash *string `json:"key_hash,omitempty"`
	// Non-secret prefix used for display and troubleshooting
	...
	// Exact model allowlist for this API key; empty allows all group models
