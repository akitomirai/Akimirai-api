...
func (_u *UserUpdate) SetPrivacyFilterConfig(v string) *UserUpdate {
	_u.mutation.SetPrivacyFilterConfig(v)
	return _u
}

// SetNillablePrivacyFilterConfig sets the "privacy_filter_config" field if the given value is not nil.
func (_u *UserUpdate) SetNillablePrivacyFilterConfig(v *string) *UserUpdate {
	if v != nil {
		_u.SetPrivacyFilterConfig(*v)
	}
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.PrivacyFilterConfig(); ok {
...
// SetPrivacyFilterConfig sets the "privacy_filter_config" field.
func (_u *UserUpdateOne) SetPrivacyFilterConfig(v string) *UserUpdateOne {
	_u.mutation.SetPrivacyFilterConfig(v)
	return _u
}

// SetNillablePrivacyFilterConfig sets the "privacy_filter_config" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillablePrivacyFilterConfig(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetPrivacyFilterConfig(*v)
	}
	return _u
