...
type User struct {
	...
	// PrivacyFilterConfig holds the value of the "privacy_filter_config" field.
	PrivacyFilterConfig string `json:"privacy_filter_config,omitempty"`
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldPasswordHash, user.FieldRole, user.FieldStatus, user.FieldUsername, user.FieldNotes, user.FieldTotpSecretEncrypted, user.FieldSignupSource, user.FieldBalanceNotifyThresholdType, user.FieldBalanceNotifyExtraEmails, user.FieldPrivacyFilterConfig:
...
func (_m *User) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case user.FieldPrivacyFilterConfig:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field privacy_filter_config", values[i])
			} else if value.Valid {
				_m.PrivacyFilterConfig = value.String
			}
		default:
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("privacy_filter_config=")
	builder.WriteString(_m.PrivacyFilterConfig)
	builder.WriteByte(')')
