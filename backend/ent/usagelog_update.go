...
func (_u *UsageLogUpdate) SetClientTransport(v string) *UsageLogUpdate {
	_u.mutation.SetClientTransport(v)
	return _u
}

// SetNillableClientTransport sets the "client_transport" field if the given value is not nil.
func (_u *UsageLogUpdate) SetNillableClientTransport(v *string) *UsageLogUpdate {
	if v != nil {
		_u.SetClientTransport(*v)
	}
	return _u
}

// ClearClientTransport clears the value of the "client_transport" field.
func (_u *UsageLogUpdate) ClearClientTransport() *UsageLogUpdate {
	_u.mutation.ClearClientTransport()
	return _u
}
...
func (_u *UsageLogUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ClientTransport(); ok {
		_spec.SetField(usagelog.FieldClientTransport, field.TypeString, value)
	}
	if _u.mutation.ClientTransportCleared() {
		_spec.ClearField(usagelog.FieldClientTransport, field.TypeString)
	}
...
// SetClientTransport sets the "client_transport" field.
func (_u *UsageLogUpdateOne) SetClientTransport(v string) *UsageLogUpdateOne {
	_u.mutation.SetClientTransport(v)
	return _u
}

// SetNillableClientTransport sets the "client_transport" field if the given value is not nil.
func (_u *UsageLogUpdateOne) SetNillableClientTransport(v *string) *UsageLogUpdateOne {
	if v != nil {
		_u.SetClientTransport(*v)
	}
	return _u
...
// ClearClientTransport clears the value of the "client_transport" field.
func (_u *UsageLogUpdateOne) ClearClientTransport() *UsageLogUpdateOne {
	_u.mutation.ClearClientTransport()
	return _u
}
